...
* @info: pointer information structure
* @estr: string containing specified error type
* Return:NULL if no numbers in string, converted number if not
* -1 on error
*/
...
/**
 * convert_number - converts a number to any base
 * @num: number to convert
 * @base: base to convert number to
 * @flags: flags to alter conversion
 *
