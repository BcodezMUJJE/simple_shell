#include "shell.h"
/**
 * _strlen - this returns a length of a string
...
/**
 * _strcmp - this performs lexicogarphic differentiation of two strangs.
 * @s1: first strang.
 * @s2: second strang.
...
/**
 * start_with -this checks if the needle starts with a haystack.
