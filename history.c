...
*
* Return: designated string that contains history file
*/
...
/**
* write_history – adds a file, or appends to an existing file
...
/**
* build_history_list – Builds a linked list of history lines.
