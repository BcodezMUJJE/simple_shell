...
{
info->status = 2;
orint_error(info, “Illegal number: “);
_eputs(info->argv[1]);
_eputchar(‘\n’);
return (1);
}
...
/**
* _mycd – changes the current process directory.
* @info: a structure that contains arguments used to maintain
* constant function prototype.
* Return: Always 0
*/
